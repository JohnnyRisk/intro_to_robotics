...
def next_move(hunter_position, hunter_heading, target_measurement, max_distance, OTHER=None):
    ...
    A = matrix([[1., 0., sin(theta0 + dtheta0), dist0 * cos(theta0 + dtheta0), dist0 * cos(theta0 + dtheta0)],
    ...
    x = matrix([[x0 + dist0 * sin(theta0 + dtheta0)],
                [y0 + dist0 * cos(theta0 + dtheta0)],
                [dist0],
                [theta0 + dtheta0],
                [dtheta0]])
    ...
    print('Objective: {}'.format(target))
    print('Hunter_Current: {}'.format(hunter_position))
    print('Target Current {}'.format(target_measurement))
...
def demo_grading(hunter_bot, target_bot, next_move_fcn, OTHER=None):
    ...
    max_distance = 2.0 * target_bot.distance  # 0.98 is an example. It will change.
...
def demo_grading1(hunter_bot, target_bot, next_move_fcn, OTHER = None):
    ...
    to the target_bot. This function is here to help you understand how we
    will grade your submission."""
    max_distance = 1.01 * target_bot.distance # 1.94 is an example. It will change.
    separation_tolerance = 0.02 * target_bot.distance # hunter must be within 0.02 step size to catch target
    caught = False
    ctr = 0
    #For Visualization
